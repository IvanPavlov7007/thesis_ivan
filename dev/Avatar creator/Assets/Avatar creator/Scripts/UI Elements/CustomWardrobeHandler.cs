...
//Ivan: copied from an example from UMA Asset, Avatar reference added

/// <summary>
/// A button that sets a recipe in a slot, or clears that slot
/// </summary>
public class CustomWardrobeHandler : MonoBehaviour
{
	public HumanoidAvatarManager Avatar;
	public UMATextRecipe Recipe;
	public string Slot;
	public string theText;

	private Color32 LoadedColor = new Color32(30, 30, 30, 255);
	...
	public void Setup(HumanoidAvatarManager avatar, UMATextRecipe recipe, string slot, string text)
	{
		Avatar = avatar;
		Recipe = recipe;
		Slot = slot;
